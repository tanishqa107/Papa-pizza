...
export default function App() {
  ...
  const renderActiveView = () => {
    switch (activeView) {
      ...
      case 'checkout':
        return <Checkout user={DEFAULT_USER} total={total} deliveryCharge={deliveryCharge} setActiveView={setActiveView} onOrderSuccess={handleSuccessfulOrder} cartItems={cart} tax={tax} appliedOffer={appliedOffer} />;
      default:
        return <Menu addToCart={addToCart} onSelectPizza={handleSelectPizza} />;
    }
  };
